...
import { FileText, Sparkles, Mail, CheckCircle2, ShieldCheck } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      icon: <FileText className="h-8 w-8 text-[#B8935A]" />,
      desc: "Collez le texte de votre appel d'offres (DCE / CCTP) et sélectionnez votre pays (France ou Belgique)."
    },
    {
      num: "Étape 2",
      title: "L'IA analyse & rédige",
      icon: <Sparkles className="h-8 w-8 text-[#B8935A]" />,
      desc: "Notre moteur extrait les exigences clés et génère une réponse commerciale complète et structurée."
    },
    {
      num: "Étape 3",
      title: "PDF reçu en 10 minutes",
      icon: <Mail className="h-8 w-8 text-[#B8935A]" />,
      desc: "Votre trame complète arrive par email sous 10 min, prête à être enrichie de vos références et tarifs."
    }
  ];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="mt-4 text-slate-300 text-sm sm:text-base leading-relaxed font-sans">
            Ne partez plus d'une page blanche : votre trame complète est générée en 10 minutes. Il ne vous reste plus qu'à l'enrichir de vos références et tarifs.
          </p>
        </div>
        ...
        <div className="mt-14 text-center flex flex-wrap items-center justify-center gap-4">
          <p className="inline-flex items-center gap-2 text-xs sm:text-sm text-slate-300 bg-slate-800/80 border border-slate-700/80 px-5 py-2.5 rounded-xl shadow-sm">
            ...
            <span>Génération en <strong>10 minutes</strong> par email</span>
          </p>

          <p className="inline-flex items-center gap-2 text-xs sm:text-sm text-slate-300 bg-slate-800/80 border border-slate-700/80 px-5 py-2.5 rounded-xl shadow-sm">
            <ShieldCheck className="h-4 w-4 text-[#B8935A] shrink-0" />
            <span><strong>Garantie révision 24h offerte</strong> sans justification</span>
          </p>
        </div>
